  ...
  return (
    <section className="media__section">
      ...
      <img
        src={shape3}
        alt="shape 3"
        className="section__img__three position"
      />
